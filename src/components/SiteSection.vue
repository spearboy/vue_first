  ...
  <section id="site">
    <div class="site__inner">
      ...
      <div class="site__wrap">
        <article v-for="(text, index) in siteText" :key="index" class="site__item">
          <span class="num">{{ index + 1 }}.</span>
          <div class="text">
            <div v-for="(line, lineIndex) in text.text" :key="lineIndex">{{ line }}</div>
          </div>
          ...
          <div class="info">
            <span v-for="(infoItem, infoIndex) in text.info" :key="infoIndex">{{ infoItem }}</span>
          </div>
        </article>
      </div>
    </div>
